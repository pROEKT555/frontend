    ...
    return(
      ...
      <nav className="Menu-test__nav">
        <ul className="Menu-test__ul" >
          ...
          <li className="Menu-test__li"><Link className="Menu-test__a" to="/test/add">Test</Link></li>
          <li className="Menu-test__li"><Link className="Menu-test__a" to="/contentvasit">Сontent</Link></li>
        </ul>
      </nav>
    </div>
    )
